...
def generate_launch_description():
	...
	param_file = os.path.join(get_package_share_directory('yahboom_multi'),'param','robot1_amcl_param.yaml')
	amcl_node = Node(
    	name="robot1_amcl",
        package='nav2_amcl',
        executable='amcl',
        parameters=[os.path.join(get_package_share_directory('yahboom_multi'),'param','robot1_amcl_param.yaml')],
