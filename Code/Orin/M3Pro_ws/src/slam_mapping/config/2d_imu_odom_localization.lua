...
TRAJECTORY_BUILDER_2D.submaps.num_range_data = 30 --单个submap存储的激光点云数量上限 default-90
...
MAP_BUILDER.pose_graph.constraint_builder.fast_correlative_scan_matcher.linear_search_window = 5 --快速相关匹配的XY方向搜索窗长（单位：米）default = 0.1
