...
class MinimalService(Node):
    ...
    def add_three_ints_callback(self, request, response):
        ...
        map_path = "/home/jetson/M3Pro_ws/src/M3Pro_navigation/map/" + map_name
        ...
        try:
            conn = sqlite3.connect("/home/jetson/M3Pro_ws/src/ros_robot_app/yahboom_app_save_map/data/xgo.db")
            c = conn.cursor()
