...
class ImageConverter :public rclcpp::Node{
    ...
    rclcpp::Subscription<std_msgs::msg::Bool>::SharedPtr Move_sub_;
...
public:
    ...
    this->angular_PID = new PID(angular_KP, angular_KI, angular_KD);
        //sub
        image_sub_=this->create_subscription<sensor_msgs::msg::Image>("/camera/color/image_raw",100,std::bind(&ImageConverter::imageCb,this,_1));
        depth_sub_=this->create_subscription<sensor_msgs::msg::Image>("/camera/depth/image_raw",100,std::bind(&ImageConverter::depthCb,this,_1));
        Joy_sub_=this->create_subscription<std_msgs::msg::Bool>("JoyState",1,std::bind(&ImageConverter::JoyCb,this,_1));
        Move_sub_=this->create_subscription<std_msgs::msg::Bool>("reset_flag",1,std::bind(&ImageConverter::MoveStatusCb,this,_1));
    ...
    void MoveStatusCb(const std::shared_ptr<std_msgs::msg::Bool> msg) ;
