...
from ament_index_python.packages import get_package_share_directory
M3Pro_demo_pkg="~/yahboomcar_ws/src/M3Pro_demo/"
...
class ColorRecognizeNode(Node):
	def __init__(self, name):
		...
		self.done_flag = True
		self.red_hsv_text = os.path.join(M3Pro_demo_pkg,'config','red_colorHSV.text')
		self.green_hsv_text = os.path.join(M3Pro_demo_pkg,'config','green_colorHSV.text')
		self.blue_hsv_text = os.path.join(M3Pro_demo_pkg,'config','blue_colorHSV.text')
		self.yellow_hsv_text = os.path.join(M3Pro_demo_pkg,'config','yellow_colorHSV.text')
		self.hsv_range = ()
