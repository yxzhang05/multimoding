...
#define ODOM_PUBLISHER_TIMEOUT       (90)    // 90
#define IMU_PUBLISHER_TIMEOUT        (40)    // 40
#define LIDAR_PUBLISHER_TIMEOUT      (140)   // 80
#define BATTERY_PUBLISHER_TIMEOUT    (1000)  // 1000
#define ARM_PUBLISHER_TIMEOUT        (500)
