 ...
 */
static int16_t Encoder_Read_CNT(uint8_t Encoder_id)
{
...
void Encoder_Debug_Handle(void)
{
    ...
    {
        count = 0;
        printf("Encoder:%ld, %ld, %ld, %ld\n", 
            Encoder_Get_Count_Now(0), Encoder_Get_Count_Now(1), 
            Encoder_Get_Count_Now(2), Encoder_Get_Count_Now(3));
    }
}
